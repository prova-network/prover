...
//
// This file is adapted from filecoin-project/curio pdp/piece_cid.go
...
//   - Package pdp -> piece
//   - No other logic changes; this is pure CommP math and has no
//     Curio-specific dependencies.

// Package piece provides content commitment (CommP) parsing and
// construction for the Prova prover.
//
// CommP is a binary-Merkle-tree commitment over 32-byte leaves using
// SHA-256 truncated to 254 bits. Prova inherits the format from the
// Filecoin storage-proof ecosystem for interoperability.
//
// Two CID flavors are supported:
//
//   - Piece CID v1: multihash type Sha2_256Trunc254Padded. No size info.
//   - Piece CID v2: multihash type Fr32Sha256Trunc254Padbintree. Encodes
//     raw byte count alongside the commitment.
package piece
